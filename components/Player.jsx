  ...
  return (
    ...
    >
        ...
        <div className={"relative h-full top-0 z-50"}>
          <div
            className={clsx(
              ...
              previewVisible ? "invisible md:visible" : "invisible",
            )}
          ...
          >
            <VideoPlayer
              ...
              style={{
                aspectRatio:
                  stegaClean(previewWidth) / stegaClean(previewHeight),
              }}
            />
            <div className={"absolute w-full h-full top-0 -z-10"}>
              <div
                className={
                  "relative w-full h-full flex items-center justify-center border border-black dark:border-white"
                }
              >
                <p>preview loading</p>
              </div>
          ...
          {isActive && (
            <div
              ...
              style={{
                aspectRatio: stegaClean(fullWidth) / stegaClean(fullHeight),
              }}
            >
              <VideoPlayer
                ref={videoPlayerRef}
      ...
      <div className={clsx("relative pointer-events-none z-10 max-h-[80%]")}>
        <div
          className={"relative h-full max-w-full md:aspect-[--aspect] "}
          style={{
            "--aspect": stegaClean(previewWidth) / stegaClean(previewHeight),
          }}
        >
          <div
            className={"relative w-full h-[20%] mt-4"}
            ref={metadataContainerRef}
          >
            {previewVisible && (
              <div
                className={clsx("hidden md:block", "relative w-full h-full")}
              >
                <Metadata
            ...
            {isActive && (
              <div className={"relative w-full h-full"}>
                <div
                  className={
                    "w-full flex items-center gap-5 pointer-events-auto mt-[1em] mb-5 z-50"
                  }
                >
                  <button
                    className={"leading-none link w-10"}
